...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        if($request->x_menu !=''){
            ...
            if(!$existe){
                $query = "nextval('reportes.mae_menu_seq') as nxt";
    ...
    public function destroy($id)
    {
        if($id !=''){
            ...
            $menu_existe = DB::select("
                ...
                from reportes.mov_menu_perfil mp 
                inner join reportes.mae_menu as m ON (mp.n_menu=m.n_menu)
    ...
    public function menuListar($id)
    {
        $list_menu = DB::select("
            ...
            (select count(mm.n_nivel) from reportes.mae_menu as mm where mm.n_nivel=m.n_menu and mm.l_activo='S') as sub_menu, mp.l_activo
            from reportes.mov_menu_perfil mp 
            inner join reportes.mae_menu as m ON (mp.n_menu=m.n_menu)
